...
import { getComponent, hasComponent, removeComponent } from '@atlas/engine/src/ecs/functions/ComponentFunctions'
...
} from '@atlas/engine/src/scene/functions/loaders/InteractableFunctions'
