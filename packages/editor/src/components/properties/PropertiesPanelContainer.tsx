...
import { PersistTagComponent } from '@atlas/engine/src/scene/components/PersistTagComponent'
import { PreventBakeTagComponent } from '@atlas/engine/src/scene/components/PreventBakeTagComponent'
import { SceneTagComponent } from '@atlas/engine/src/scene/components/SceneTagComponent'
import { VisibleComponent } from '@atlas/engine/src/scene/components/VisibleComponent'
import { SCENE_COMPONENT_PERSIST } from '@atlas/engine/src/scene/functions/loaders/PersistFunctions'
import { SCENE_COMPONENT_PREVENT_BAKE } from '@atlas/engine/src/scene/functions/loaders/PreventBakeFunctions'
import { SCENE_COMPONENT_VISIBLE } from '@atlas/engine/src/scene/functions/loaders/VisibleFunctions'
