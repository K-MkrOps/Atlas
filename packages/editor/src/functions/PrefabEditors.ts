...
import { SCENE_COMPONENT_SCENE_TAG } from '@atlasfoundation/engine/src/scene/components/SceneTagComponent'
import { SCENE_COMPONENT_AMBIENT_LIGHT } from '@atlasfoundation/engine/src/scene/functions/loaders/AmbientLightFunctions'
import { SCENE_COMPONENT_ASSET } from '@atlasfoundation/engine/src/scene/functions/loaders/AssetComponentFunctions'
import { SCENE_COMPONENT_AUDIO } from '@atlasfoundation/engine/src/scene/functions/loaders/AudioFunctions'
import { SCENE_COMPONENT_BOX_COLLIDER } from '@atlasfoundation/engine/src/scene/functions/loaders/BoxColliderFunctions'
import { SCENE_COMPONENT_CAMERA_PROPERTIES } from '@atlasfoundation/engine/src/scene/functions/loaders/CameraPropertiesFunctions'
import { SCENE_COMPONENT_CLOUD } from '@atlasfoundation/engine/src/scene/functions/loaders/CloudFunctions'
import { SCENE_COMPONENT_CUBEMAP_BAKE } from '@atlasfoundation/engine/src/scene/functions/loaders/CubemapBakeFunctions'
import { SCENE_COMPONENT_DIRECTIONAL_LIGHT } from '@atlasfoundation/engine/src/scene/functions/loaders/DirectionalLightFunctions'
import { SCENE_COMPONENT_GROUND_PLANE } from '@atlasfoundation/engine/src/scene/functions/loaders/GroundPlaneFunctions'
import { SCENE_COMPONENT_GROUP } from '@atlasfoundation/engine/src/scene/functions/loaders/GroupFunctions'
import { SCENE_COMPONENT_HEMISPHERE_LIGHT } from '@atlasfoundation/engine/src/scene/functions/loaders/HemisphereLightFunctions'
import { SCENE_COMPONENT_IMAGE } from '@atlasfoundation/engine/src/scene/functions/loaders/ImageFunctions'
import { SCENE_COMPONENT_INTERIOR } from '@atlasfoundation/engine/src/scene/functions/loaders/InteriorFunctions'
import { SCENE_COMPONENT_MODEL } from '@atlasfoundation/engine/src/scene/functions/loaders/ModelFunctions'
import { SCENE_COMPONENT_OCEAN } from '@atlasfoundation/engine/src/scene/functions/loaders/OceanFunctions'
import { SCENE_COMPONENT_PARTICLE_EMITTER } from '@atlasfoundation/engine/src/scene/functions/loaders/ParticleEmitterFunctions'
import { SCENE_COMPONENT_POINT_LIGHT } from '@atlasfoundation/engine/src/scene/functions/loaders/PointLightFunctions'
import { SCENE_COMPONENT_PORTAL } from '@atlasfoundation/engine/src/scene/functions/loaders/PortalFunctions'
import { SCENE_COMPONENT_POSTPROCESSING } from '@atlasfoundation/engine/src/scene/functions/loaders/PostprocessingFunctions'
import { SCENE_COMPONENT_SCENE_PREVIEW_CAMERA } from '@atlasfoundation/engine/src/scene/functions/loaders/ScenePreviewCameraFunctions'
import { SCENE_COMPONENT_SKYBOX } from '@atlasfoundation/engine/src/scene/functions/loaders/SkyboxFunctions'
import { SCENE_COMPONENT_SPAWN_POINT } from '@atlasfoundation/engine/src/scene/functions/loaders/SpawnPointFunctions'
import { SCENE_COMPONENT_SPLINE } from '@atlasfoundation/engine/src/scene/functions/loaders/SplineFunctions'
import { SCENE_COMPONENT_SPOT_LIGHT } from '@atlasfoundation/engine/src/scene/functions/loaders/SpotLightFunctions'
import { SCENE_COMPONENT_SYSTEM } from '@atlasfoundation/engine/src/scene/functions/loaders/SystemFunctions'
import { SCENE_COMPONENT_TRIGGER_VOLUME } from '@atlasfoundation/engine/src/scene/functions/loaders/TriggerVolumeFunctions'
import { SCENE_COMPONENT_VIDEO } from '@atlasfoundation/engine/src/scene/functions/loaders/VideoFunctions'
import { SCENE_COMPONENT_VOLUMETRIC } from '@atlasfoundation/engine/src/scene/functions/loaders/VolumetricFunctions'
import { SCENE_COMPONENT_WATER } from '@atlasfoundation/engine/src/scene/functions/loaders/WaterFunctions'
